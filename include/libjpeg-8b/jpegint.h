...
EXTERN(void) copy_buff JPP((j_decompress_ptr cinfo,  const unsigned char * in_buff,
                            unsigned int bytes_in_buffer, unsigned int bytes_in_total,
                            unsigned int * fillframedone));
#endif
