...
dtb-$(BUILD_ENABLE) += tegra234-p3767-0003-p3768-0000-a0-gmsl-0.dtb
dtb-$(BUILD_ENABLE) += tegra234-p3767-0003-p3768-0000-a0-gmsl-1.dtb
dtb-$(BUILD_ENABLE) += tegra234-p3767-0003-p3768-0000-a0-gmsl-2.dtb
dtb-$(BUILD_ENABLE) += tegra234-p3767-0003-p3768-0000-a0-gmsl-3.dtb
dtb-$(BUILD_ENABLE) += tegra234-p3767-0003-p3768-0000-a0-gmsl-4.dtb
