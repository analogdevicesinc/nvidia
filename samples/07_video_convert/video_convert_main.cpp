...
create_thread_context(context_t *ctx, struct thread_context *tctx, int index)
{
    ...
    */
    ...
    tctx->input_params.chromaSubsampling.chromaLocHoriz = ctx->in_chroma_loc.horiz;
    tctx->input_params.chromaSubsampling.chromaLocVert = ctx->in_chroma_loc.vert;
    ...
    tctx->output_params.chromaSubsampling.chromaLocHoriz = ctx->out_chroma_loc.horiz;
    tctx->output_params.chromaSubsampling.chromaLocVert = ctx->out_chroma_loc.vert;
...
set_defaults(context_t * ctx)
{
    ...
    ctx->out_chroma_loc.horiz = 0;
    ctx->out_chroma_loc.vert = 0;
    ctx->in_chroma_loc.horiz = 0;
    ctx->in_chroma_loc.vert = 0;
}
